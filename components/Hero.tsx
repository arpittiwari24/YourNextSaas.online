...
const Hero = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    ...
    <div className="">
    <h1 className="bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text text-transparent text-5xl font-extrabold py-1 ">Build with a smile : {")"}<br />The foundation for your <span className="next-sass text-transparent bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text lg:py-1">Next Saas</span></h1>
      <p className="py-6 pb-8 text-black">Boost your speed while building your next sass with our open sourced boilerplate. Spend your time in building those new features rather that setting up payments and authentication .</p>
