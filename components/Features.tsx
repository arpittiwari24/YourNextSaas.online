const Features = () => {
  return (
    <div className="bg-background bg-grid-white/[0.03]">
          ...
          <div className="grid gap-x-6 md:grid-cols-2 lg:grid-cols-4 lg:gap-x-12">
            <div className="mb-12 lg:mb-0 ">
              ...
              <p className="text-neutral-500 ">
                ...
                assist you with any queries or issues you might encounter.
              </p>
            </div>
            <div className="mb-12 lg:mb-0">
              <div className="mb-6 inline-block rounded-full bg-primary-100 p-4 text-primary border">
              ...
              <p className="text-neutral-500 ">
                We ensure the security and reliability of your shortened URLs,
            ...
            <div className="mb-12 md:mb-0">
              ...
              <p className="text-neutral-500 ">
                With our advanced infrastructure, we guarantee lightning-fast
                redirection times for your shortened URLs.
              </p>
            </div>
            <div className="mb-12 md:mb-0">
              <div className="mb-6 inline-block rounded-full bg-primary-100 p-4 text-primary border">
              ...
              <p className="text-neutral-500 ">
                Gain valuable insights into your audience and track the
                performance of your shortened URLs in real-time .
              </p>
            </div>
          </div>
        </section>
